...
summary: 'JS: types cheat sheet. A type defines how values in memory are interpreted.
  Primitive types store values directly in variables, while reference types store
  links to objects. The post explains this with simple examples.'
title: 'JS: types'
