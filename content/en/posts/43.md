...
summary: Короткие заметки о JavaScript и маленькие программки. [кран ](<https://am-lang.web.app/assets/crane_swap-DogT7VS-.webp>)
  Симулятор обмена трёх переменных Конспект ✍️React-симулятор обмена трёх переменных
  ✍️[Ссылка](<http
title: Короткие заметки о JavaScript и маленькие программки.
updated_at: '2026-03-02T09:20:24.545855+00:00'
---
